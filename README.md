...
> 基于 Security + Line AccessToken 的 Spring Boot Starter 实现

主要 扩展Security、Line AccessToken 与Spring Boot的整合，实现通过yaml配置即可实现权限拦截扩展，类似Shiro的 shiro.ini 配置方式
